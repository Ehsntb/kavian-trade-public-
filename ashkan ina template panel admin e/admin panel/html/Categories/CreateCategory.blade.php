            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center border-bottom">
                        <h2 class="content-title card-title">ایجاد دسته جدید</h2>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('categories.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <label for="title" class="form-label">عنوان دسته بندی مادر</label>
                                ...
                                <div class="col-lg-6">
                                    <label for="title" class="form-label">تصویر دسته مادر</label>
